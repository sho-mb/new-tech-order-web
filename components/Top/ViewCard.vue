<template>
  <div data-aos="zoom-in">
    ...
    >
      <div
        class="rounded-[45px] md:w-full relative"
      >
        <img
          :src="backgroundUrl"
          class="md:w-full w-full h-full object-cover"
        >
        <div
        ...
        <div
          v-if="isPop"
          class="absolute top-0 flex justify-center items-center w-full h-full text-8 md:text-5xl font-bold"
        >
          POP
        </div>
        <div
