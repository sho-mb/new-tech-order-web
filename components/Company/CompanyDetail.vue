  ...
  >
    <div class="md:px-40 text-center">
      <img
        ...
        class="w-160px md:w-320px"
      >
    </div>
    <div class="md:w-[50%] mt-80px md:mt-0">
      <div class="md:w-320px md:text-left">
        <div
          class="text-2xl md:text-5xl font-bold md:leading-13"
          v-html="companyText.logo.title"
        />
        <div class="border-b-solid bg-white w-125px md:w-full md:h-1 mt-4" />
        <div
          class="mt-4"
